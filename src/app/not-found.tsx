...
function notFound() {
  return (
    <div className='w-full h-fit mx-auto max-w-6xl flex flex-col items-center gap-4 p-3'>
      ...
      <div className='w-full border-t grid grid-cols-1 lg:grid-cols-2 gap-3.5 py-5'>
        <div className='flex justify-center items-center gap-4 p-4'>
            <span className='text-9xl font-extrabold text-brand text-shadow-[0_3px_10px_black] font-sans'>4</span>
            <span className='text-9xl font-extrabold text-brand text-shadow-[0_3px_10px_black] font-sans'>0</span>
            <span className='text-9xl font-extrabold text-brand text-shadow-[0_3px_10px_black] font-sans'>4</span>
        </div>
